...
import com.rho.cordovabarcode.CordovabarcodeFactory;
...
public class BarcodeScanner {
     ...
     * Constructor.
     */
    public BarcodeScanner(IMethodResult result) {
        this.result = result;
        Log.i("rho", "BARCODE CONSTRUCTOR");
    }
...
//        intentScan.setPackage(this.cordova.getActivity().getApplicationContext().getPackageName());
        intentScan.setPackage(ra.getApplicationContext().getPackageName());

        Intent intent = new Intent(ra, com.google.zxing.client.android.CaptureActivity.class);
        Activity activity = RhodesActivity.getInstance();
...
//        intentEncode.setPackage(this.cordova.getActivity().getApplicationContext().getPackageName());
        intentEncode.setPackage(ra.getApplicationContext().getPackageName());

        ra.startActivity(intentEncode);
